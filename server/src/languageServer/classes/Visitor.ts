...
export abstract class Visitor<T = void, U = void> {
    ...
    constructor() {
        ...
        this.visitMap.set("CompoundAssignOperator", (n: CompoundAssignOperator, t: T, v: Visitor<T, U>) => v.visitCompoundAssignOperator(n, t));
        this.visitMap.set("ConditionalOperator", (n: ConditionalOperator, t: T, v: Visitor<T, U>) => v.visitConditionalOperator(n, t));
